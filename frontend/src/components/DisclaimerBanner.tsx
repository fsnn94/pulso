    ...
    <div className="bg-accent-500/10 border-b border-accent-500/15 text-ink-700 dark:text-ink-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2 flex items-start sm:items-center gap-3 text-[13px]">
        ...
        <p className="leading-snug">
          <span className="font-medium">Créditos virtuales.</span> Pulso es una plataforma de mercados de predicción.
          Se opera con créditos virtuales — sin dinero real, sin pagos, sin valores. No disponible donde esté prohibido.
        </p>

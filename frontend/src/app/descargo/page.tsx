...
export default function DescargoPage() {
  return (
    ...
    >
      <DocSection title="Se opera con créditos virtuales">
        <p>
          Pulso es una <strong>plataforma de mercados de predicción sobre eventos futuros</strong>.
          Toda la operatoria se realiza con <strong>créditos virtuales</strong>: no hay depósitos,
          retiros, premios ni pagos en dinero real, y no se puede convertir el saldo en fondos reales.
        </p>
      </DocSection>
      ...
      <DocSection title="No es asesoramiento ni un servicio financiero">
        <ul>
          ...
          <li>Los precios reflejan el consenso de la comunidad de participantes; <strong>no predicen el futuro</strong> ni garantizan resultado alguno.</li>
        </ul>
      </DocSection>

      <DocSection title="Sin garantías">
        <p>
          El servicio se ofrece "tal cual". No garantizamos
